package com.infinite.mynewsapp.data

import androidx.lifecycle.LiveData
import androidx.lifecycle.MediatorLiveData
import androidx.viewbinding.BuildConfig
import com.infinite.mynewsapp.data.local.entity.NewsEntity
import com.infinite.mynewsapp.data.local.room.NewsDao
import com.infinite.mynewsapp.data.remote.response.NewsResponse
import com.infinite.mynewsapp.data.remote.retrofit.ApiService
...
class NewsRepository private constructor(
    ...
    fun getHeadlineNews(): LiveData<Result<List<NewsEntity>>> {
        ...
        val client = apiService.getNews(BuildConfig.BUILD_TYPE)
